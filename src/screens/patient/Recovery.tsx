...
const badges = [
  { name: '1st Week Complete', unlocked: true, icon: '🏆', color: 'from-amber-400 to-orange-500' },
  { name: 'Perfect Vitals', unlocked: true, icon: '💚', color: 'from-emerald-400 to-green-500' },
  { name: '7-Day Streak', unlocked: true, icon: '🔥', color: 'from-orange-400 to-red-500' },
  { name: 'Pain-Free Day', unlocked: false, icon: '✨', color: 'from-slate-300 to-slate-400' },
  { name: 'Medication Master', unlocked: false, icon: '💊', color: 'from-slate-300 to-slate-400' },
  { name: 'Recovery Champion', unlocked: false, icon: '👑', color: 'from-slate-300 to-slate-400' },
];
...
export function Recovery() {
  ...
  return (
    <div className="pb-24 px-4 pt-6 max-w-md mx-auto">
      ...
      <PageHeader title="Recovery Progress" subtitle="7-day trends & achievements" />

      {/* Summary */}
      <Card className="mb-4 bg-gradient-to-br from-primary-600 to-primary-800 text-white border-0">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-primary-100 text-sm">Current Recovery Score</p>
            <p className="text-4xl font-extrabold">{state.patients[0].recoveryScore}%</p>
            <Chip color="success"><TrendingUp size={12} /> +18% this week</Chip>
          </div>
      ...
      {/* Pain trend */}
      <Card className="mb-4">
        <p className="font-bold text-slate-800 dark:text-white text-sm mb-3">Pain Level (7 days)</p>
      ...
      {/* Sleep trend */}
      <Card className="mb-4">
        <p className="font-bold text-slate-800 dark:text-white text-sm mb-3">Sleep Quality (7 days)</p>
        <ResponsiveContainer width="100%" height={160}>
      ...
      <Card className="mb-4">
        <p className="font-bold text-slate-800 dark:text-white text-sm mb-3">Recovery Score Trend</p>
        <ResponsiveContainer width="100%" height={160}>
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        <p className="font-bold text-slate-800 dark:text-white">Achievement Badges</p>
      </div>
